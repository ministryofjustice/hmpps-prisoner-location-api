...
import uk.gov.justice.digital.hmpps.prisonerlocationapi.resource.ExtractFileNotFound
...
class HmppsPrisonerLocationApiExceptionHandler {
  ...
  @ExceptionHandler(ExtractFileNotFound::class)
  fun handleException(e: ExtractFileNotFound): ResponseEntity<ErrorResponse> = ResponseEntity
    .status(NOT_FOUND)
    .body(
      ErrorResponse(
        status = NOT_FOUND,
